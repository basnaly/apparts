...
const handler = async (req, res) => {
	...
	(id, currency, priceMin, priceMax, unit, areaMin, areaMax, bedroomsMin, bedroomsMax, bathroomsMin, bathroomsMax, isHome, isCottage, isAppartment, preferAreaEstate, yearbuildMin, yearbuildMax, floorMin, floorMax, parkingMin, parkingMax, addRequest) 
